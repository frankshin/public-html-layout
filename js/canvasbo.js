function SiriWave(opt){
	...
	(this.opt.container || document.getElementById("canvasbo")).appendChild(this.canvas);
...
SiriWave.prototype = {
	...
	_draw: function(){
		...
		this._clear();
		this._drawLine(-2, '#E4E2E7',1.5);
		this._drawLine(-6, '#E4E2E7',1.5);
		// this._drawLine(4, '#E4E2E7',1.5);
		// this._drawLine(2, '#E4E2E7',1.5);
		this._drawLine(1, '#E4E2E7',2.5);
